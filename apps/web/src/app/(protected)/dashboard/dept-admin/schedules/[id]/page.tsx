...
export default function DeptAdminScheduleDetailPage({ params }: { params: { id: string } }) {
  ...
  if (!schedule) {
    return (
      <div className="text-center py-16">
        <p className="text-lg text-slate-400">Program bulunamadı veya erişim yetkiniz yok</p>
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          <Link href={`/dashboard/dept-admin/schedules/${id}/calendar`}>
