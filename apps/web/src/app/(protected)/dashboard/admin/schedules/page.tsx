...
export default function AdminSchedulesPage() {
  ...
  const setStatus = (status: string) => {
    ...
    router.push(`/dashboard/admin/schedules?${params.toString()}`)
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-400">Nöbet ve ders programlarını yönetin</p>
          </div>
        </div>
      ...
      {loading ? (
        ...
        <ScheduleList schedules={schedules} basePath="/dashboard/admin" />
      )}
    </div>
  )
}
